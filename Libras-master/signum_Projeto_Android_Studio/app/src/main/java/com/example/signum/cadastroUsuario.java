...
public class cadastroUsuario extends AppCompatActivity {
    ...
    private void CreateAccount(Users usuario)
    {
        ...
        else if(!TextUtils.isEmpty(usuario.getEmail()) && !Patterns.EMAIL_ADDRESS.matcher(usuario.getEmail()).matches()) {
            Toast.makeText(this, "por favor escreva seu email no formato padrão. Ex: exemplo@hotmail.com ", Toast.LENGTH_SHORT).show();
        }
